  ...
  return (
    <ListViewLayout
      ...
      filters={
        <div className="surface-card flex flex-col gap-4 p-4 lg:flex-row lg:items-end">
          ...
          <Skeleton className="h-10 w-full rounded-xl lg:w-44" />
        </div>
      }
      footer={
    ...
    >
      <div className="surface-card overflow-hidden">
        <div className="space-y-0 border-b border-indigo-100/80 bg-linear-to-r from-indigo-50/60 to-violet-50/40 px-5 py-3.5">
